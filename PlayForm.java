...
public class PlayForm extends javax.swing.JFrame {
    ...
    public static void main() {
        ...
        public void setDetails(String n, String df, int di){
            this.name = n;
            this.difficulty=df;
            this.d = di;
            jLabel5.setText(n);
            jLabel6.setText(df);
            System.out.println("in setDetails method");
            makeQuestion(d, 0, question, name);
        }//setDetails
    
        public void makeQuestion(int difficulty, int score, int question, String name){
        Random r = new Random();
...
/*----------------------------------------------------------------------------*/        
        ...
        Double userAns = Double.parseDouble(jTextField1.getText());
        //check user answer
        try{
            if(Math.round(userAns)==correctAns){
        ...
        jLabel4.setText("Lives " + lives);
        question++;
        if(lives==0){
            jLabel7.setText("No lives left.  Game Over.");
            fileAccess fa = new fileAccess();
            ArrayList<Player> players = fa.loadScoreFile();
            Player p = new Player(name, score, d, "");
            players.add(p);
            fa.updateScoreFile(players);
            this.hide();
        }
        else
            makeQuestion(d, score, question, name);
